...
export default function SortableItem({ item, index, updateItem, removeItem, itemsLength }: SortableItemProps) {
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes} className="border-t border-gray-200 px-4 py-2">
