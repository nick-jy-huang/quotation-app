  ...
  return (
    <div className="grid">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Input label="報價單編號" value={quotation.id} onChange={value => updateQuotation('id', value)} />
        <Input label="報價日期" type="date" value={quotation.date} onChange={value => updateQuotation('date', value)} />
        <Input
          label="有效期至"
          type="date"
