  ...
  (
    {
      ...
      textareaClassName = 'w-full rounded-md border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-700 focus:outline-none dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100',
