...
export default function ClientInfo({ customerName, customerPhone, customerEmail, customerAddress }: ClientInfoProps) {
  return (
    <div className="mb-4">
      <h3 className="mb-3 border-b pb-2 text-lg font-semibold text-gray-800">客戶資訊</h3>
